 ...
 * Uses the OpenAI SDK with Ollama's OpenAI-compatible endpoint.
 * Supports both local (http://localhost:11434/v1) and cloud (https://ollama.com/api) deployments.
 */
